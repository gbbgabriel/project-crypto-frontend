export class AbleProConfig {
  ...
  static isDarkMode = 'dark'; // light, dark, auto
  static theme_color = 'red-theme'; // blue-theme, indigo-theme, purple-theme, pink-theme, red-theme, orange-theme, yellow-theme, green-theme, teal-theme, cyan-theme
